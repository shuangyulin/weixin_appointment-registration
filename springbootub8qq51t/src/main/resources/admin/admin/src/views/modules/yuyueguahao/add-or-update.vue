		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="专业特长" prop="zhuanyetezhang" >
					<el-input v-model="ruleForm.zhuanyetezhang" placeholder="专业特长" clearable  :readonly="ro.zhuanyetezhang"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="专业特长" prop="zhuanyetezhang" >
					<el-input v-model="ruleForm.zhuanyetezhang" placeholder="专业特长" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="select" v-if="type!='info'"  label="预约时间" prop="yuyueshijian" >
					<el-select :disabled="ro.yuyueshijian" v-model="ruleForm.yuyueshijian" placeholder="请选择预约时间" >
						<el-option
							v-for="(item,index) in yuyueshijianOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="预约时间" prop="yuyueshijian" >
				...
				<el-form-item class="select" v-if="type!='info'"  label="挂号号源" prop="shengyuhaoyuan" >
					<el-select :disabled="ro.shengyuhaoyuan" v-model.number="ruleForm.shengyuhaoyuan" placeholder="请选择挂号号源" >
						<el-option
							v-for="(item,index) in shengyuhaoyuanOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item v-else class="input" label="挂号号源" prop="shengyuhaoyuan" >
					<el-input v-model="ruleForm.shengyuhaoyuan"
						placeholder="挂号号源" readonly></el-input>
				</el-form-item>
	...
	export default {
		data() {
			...
			return {
				...
				rules: {
					...
					shengyuhaoyuan: [
						{ required: true, message: '挂号号源不能为空', trigger: 'blur' },
						{ validator: validateIntNumber, trigger: 'blur' },
					],
					guahaozhuangtai: [
					],
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='shengyuhaoyuan'){
							this.ruleForm.shengyuhaoyuan = obj[o];
							this.ro.shengyuhaoyuan = true;
							continue;
						}
					...
					this.ruleForm.shengyuhaoyuan = 0
					this.ro.shengyuhaoyuan = false;
					this.ruleForm.guahaozhuangtai = '已预约'; 				}
				// 获取用户信息
				this.$http({
				...
				this.yuyueshijianOptions = "上午:9:00--9;30,上午:9:30--10:00,上午:10:00--10:30,上午:10:30--11:00,上午:11:00--11:30,上午:11:30--12:00,下午:14:00--14:30,下午:14:30--15:00,下午:15:30--16:00,下午:16:30--17:00,下午:17:00--17:30".split(',')
				this.shengyuhaoyuanOptions = "1".split(',')
				this.guahaozhuangtaiOptions = "已取消,已预约".split(',')
			...
			async onSubmit() {
					...
					if(objcross!=null) {
						if(!this.ruleForm.shengyuhaoyuan){
							this.$message.error("挂号号源不能为空");
							return
						}
						objcross.shengyuhaoyuan = objcross.shengyuhaoyuan - this.ruleForm.shengyuhaoyuan
						if(objcross.shengyuhaoyuan<0){
							this.$message.error("挂号号源不足");
							return
						}
											}
					if(!this.ruleForm.id) {
